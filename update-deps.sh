...
sed -i.bak 's/^APP_SECRET=.*$/APP_SECRET=8igS3cr3t/' .env
# Compatibility with our Docker and Kubernetes setup
sed -i.bak 's;^DATABASE_URL="postgresql://db_user:db_password@127.0.0.1:5432/db_name?serverVersion=13\&charset=utf8"$;DATABASE_URL="postgresql://api-platform:8igS3cr3t@database:5432/api?serverVersion=13\&charset=utf8";' .env
